...
Route::get('/invitations/{token}', [ProjectInvitationAcceptController::class, 'show']);
...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::apiResource('projects.invitations', ProjectInvitationController::class)->only(['index', 'store', 'destroy']);
...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/forgot-password', [ForgotPasswordController::class, 'sendLink'])->middleware('throttle:auth');
    Route::post('/reset-password', [ResetPasswordController::class, 'reset'])->middleware('throttle:auth');
