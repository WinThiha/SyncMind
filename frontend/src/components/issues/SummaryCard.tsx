      ...
      <div className="p-4 sm:p-6">
        ...
        {loading ? (
          <div className="py-8 text-center space-y-3">
            ...
            <p className="text-sm text-indigo-600 font-medium">Analyzing discussion and history...</p>
          </div>
        ) : summary && (
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-indigo-100 flex items-center">
              ...
              <span className="text-xs font-bold text-indigo-400 uppercase tracking-wider mr-2">Consensus:</span>
